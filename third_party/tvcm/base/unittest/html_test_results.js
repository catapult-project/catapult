...
base.exportTo('base.unittest', function() {
  var TestStatus = base.unittest.TestStatus;
  ...
  HTMLTestCaseResult.prototype = {
    ...
    addError: function(normalizedException) {
      ...
      errorEl.appendChild(base.instantiateTemplate(
  ...
  HTMLTestResults.prototype = {
    ...
    didCurrentTestEnd: function() {
      ...
      if (testCaseResult.hadErrors) {
        ...
        base.dispatchSimpleEvent(this, 'testfailed');
      } else {
        this.log_('[PASSED]\n');
        this.numTestsThatPassed_ += 1;
        base.dispatchSimpleEvent(this, 'testpassed');
      }
    ...
    log_: function(msg) {
      ...
      base.dispatchSimpleEvent(this, 'statschange');
    }
  };
