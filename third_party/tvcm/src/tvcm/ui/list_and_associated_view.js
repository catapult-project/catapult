...
tvcm.requireStylesheet('tvcm.ui.list_and_associated_view');
tvcm.exportTo('tvcm.ui', function() {

  /**
   * @constructor
   */
  var ListAndAssociatedView = tvcm.ui.define('x-list-and-associated-view');
  ListAndAssociatedView.prototype = {
    ...
    decorate: function() {
      ...
      this.listView_ = new tvcm.ui.ListView();
