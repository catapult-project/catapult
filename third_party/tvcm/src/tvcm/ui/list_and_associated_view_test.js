...
tvcm.require('tvcm.ui.list_and_associated_view');

tvcm.unittest.testSuite('tvcm.ui.list_and_associated_view_test', function() {
  var ListAndAssociatedView = tvcm.ui.ListAndAssociatedView;

  var SimpleView = tvcm.ui.define('div');
