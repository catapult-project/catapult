...
tvcm.exportTo('tvcm.unittest', function() {
  ...
  Assertions.prototype = {
    assertTrue: function(a, opt_message) {
      ...
      throw new tvcm.unittest.TestError(message);
    },
    ...
    assertEquals: function(a, b, opt_message) {
      if (a === b)
        return;
      if (opt_message)
        throw new tvcm.unittest.TestError(opt_message);
    ...
    assertVisible: function(elt) {
      if (!elt.offsetHeight || !elt.offsetWidth)
        throw new tvcm.unittest.TestError('Expected element to be visible');
    }
  };
