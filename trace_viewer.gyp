...

{
  'variables': {
    'tracing_css_files': [
      ...
      'trace_viewer/tracing/side_panel/side_panel_container.css',
    ...
    'tracing_js_html_files': [
      ...
      'trace_viewer/extras/analysis/analyze_samples.html',
      ...
      'trace_viewer/extras/cc/raster_task_sub_view.html',
      'trace_viewer/extras/cc/raster_task_sub_view_for_tasks_from_different_lthi.html',
      'trace_viewer/extras/cc/raster_task_sub_view_for_tasks_from_same_lthi.html',
      ...
      'trace_viewer/net.html',
      'trace_viewer/net/net_async_slice.html',
      ...
      'trace_viewer/tcmalloc/tcmalloc.html',
      ...
      'trace_viewer/tracing/analysis/view_base.html',
      ...
      'trace_viewer/tracing/importer/empty_importer.html',
      ...
      'trace_viewer/tracing/importer/linux_perf/irq_parser.html',
      'trace_viewer/tracing/importer/linux_perf/kfunc_parser.html',
      'trace_viewer/tracing/importer/linux_perf/mali_parser.html',
      'trace_viewer/tracing/importer/linux_perf/memreclaim_parser.html',
      ...
      'trace_viewer/tracing/side_panel/side_panel_container.html',
      'trace_viewer/tracing/side_panel/side_panel_registry.html',
      ...
      'trace_viewer/tracing/trace_model/trace_model.html',
      'trace_viewer/tracing/trace_model/trace_model_settings.html',
      ...
      'trace_viewer/tracing/tracks/highlighter.html',
      'trace_viewer/tracing/tracks/highlighter/highlighter.html',
      'trace_viewer/tracing/tracks/highlighter/vsync_highlighter.html',
    ...
    'tracing_img_files': [
      ...
      'trace_viewer/tcmalloc/images/collapse.png',
      'trace_viewer/tcmalloc/images/expand.png',
    ],
    'tracing_files': [
      '<@(tracing_css_files)',
      '<@(tracing_js_html_files)',
