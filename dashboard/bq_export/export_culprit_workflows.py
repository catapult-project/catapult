...
r"""Export Culprit Workflows jobs to BigQuery with Beam & Cloud Dataflow.
...
reasonable defaults for other values)::
  ...
  $ python bq_export/export_clouw_workflows.py \
...
from bq_export import bq_culprit_workflows

if __name__ == '__main__':
  logging.getLogger().setLevel(logging.INFO)
  bq_culprit_workflows.main()
