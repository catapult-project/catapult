...
class EditConfigHandlerTest(testing_common.TestCase):
  ...
  def _AddSampleTestData(self):
    ...
    t = graph_data.TestMetadata(id='TheMaster/TheBot/Suite1/aaa', has_rows=True)
    t.UpdateSheriff()
    t.put()

    t = graph_data.TestMetadata(id='TheMaster/TheBot/Suite1/bbb', has_rows=True)
    t.UpdateSheriff()
    t.put()

    t = graph_data.TestMetadata(id='TheMaster/TheBot/Suite2/ccc', has_rows=True)
    t.UpdateSheriff()
    t.put()

    t = graph_data.TestMetadata(id='TheMaster/TheBot/Suite2/ddd', has_rows=True)
    t.UpdateSheriff()
    t.put()
