...
var DRIVE_FILE_ID = '0B...';

function run() {
  var service = getService(getPrivateKeyDetailsFromDriveFile(DRIVE_FILE_ID));
  if (service.hasAccess()) {
    // Make API calls by adding the Authorization header.
    var url = 'https://chromeperf.appspot.com/api/alerts/bug_id/713717';
