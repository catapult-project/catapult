...
"""Unit tests for update_bug_from_rietveld module."""
...
from dashboard import update_bug_from_rietveld
...
===== BISECT JOB RESULTS =====
Status: Successful with low confidence and warnings.
...
Rietveld issue: https://test-rietveld.appspot.com/api/200037/1
"""
...
Rietveld issue: https://test-rietveld.appspot.com/api/200039/1
"""
...
_PERF_TEST_CONFIG = """config = {
  'command': 'tools/perf/run_benchmark -v --browser=release dromaeo.jslibstylejquery --profiler=trace',
...
_PERF_EXPECTED_SUCCESS_HTML_EMAIL = """
Perf Try Job SUCCESS
<br><br>
A Perf Try Job was submitted on win_perf_bisect at
<a href="http://build.chromium.org/508">http://build.chromium.org/508</a>.<br>
<table cellpadding='4'>
  <tr><td>Bot:</td><td><b>win_perf_bisect</b></td>
  <tr><td>Test:</td><td><b>tools/perf/run_benchmark -v --browser=release dromaeo.jslibstylejquery --profiler=trace</b></td>
  <tr><td>Revision Range:</td><td><b>215806 - 215828</b></td>
  <tr><td>HTML Results:</td><td><b>http://storage.googleapis.com/chromium-telemetry/html-results/results-2014-11-27_14-10-21</b></td>
  <tr><td>With Patch - Profiler Data[0]:</td><td><b>https://console.developers.google.com/m/cloudstorage/b/chrome-telemetry/o/profiler-file-id_0-2014-11-27_14-08-5560487.json</b></td>
<tr><td>Without Patch - Profiler Data[0]:</td><td><b>https://console.developers.google.com/m/cloudstorage/b/chrome-telemetry/o/profiler-file-id_0-2014-11-27_14-10-1644780.json</b></td>

</table><p>"""

_PERF_EXPECTED_SUCCESS_TEXT_EMAIL = """
Perf Try Job SUCCESS

Bot: win_perf_bisect
Test: tools/perf/run_benchmark -v --browser=release dromaeo.jslibstylejquery --profiler=trace
Revision Range:215806 - 215828

HTML Results: http://storage.googleapis.com/chromium-telemetry/html-results/results-2014-11-27_14-10-21
With Patch - Profiler Data[0]: https://console.developers.google.com/m/cloudstorage/b/chrome-telemetry/o/profiler-file-id_0-2014-11-27_14-08-5560487.json
Without Patch - Profiler Data[0]: https://console.developers.google.com/m/cloudstorage/b/chrome-telemetry/o/profiler-file-id_0-2014-11-27_14-10-1644780.json

+++++++++++++++++++++++++++++++"""

_PERF_EXPECTED_FAILURE_HTML_EMAIL = """
Perf Try Job FAILURE
<br><br>
A Perf Try Job was submitted on win_perf_bisect at
<a href="http://build.chromium.org/508">http://build.chromium.org/508</a>.<br>
<table cellpadding='4'>
  <tr><td>Bot:</td><td><b>win_perf_bisect</b></td>
  <tr><td>Test:</td><td><b>?</b></td>
  <tr><td>Revision Range:</td><td><b>? - ?</b></td>
  <tr><td>HTML Results:</td><td><b></b></td>
  
</table><p>"""

_PERF_EXPECTED_FAILURE_TEXT_EMAIL = """
Perf Try Job FAILURE
...
class UpdateBugFromRietveldTest(testing_common.TestCase):

  def setUp(self):
    super(UpdateBugFromRietveldTest, self).setUp()
    app = webapp2.WSGIApplication([(
        '/update_bug_from_rietveld',
        update_bug_from_rietveld.UpdateBugFromRietveldHandler)])
  ...
  @mock.patch.object(
      update_bug_from_rietveld.issue_tracker_service, 'IssueTrackerService',
      mock.MagicMock())
  @mock.patch.object(
      update_bug_from_rietveld.buildbucket_service, 'GetJobStatus',
      _MockGetJobStatus)
  def testGet(self):
  ...
  @mock.patch.object(
      update_bug_from_rietveld.issue_tracker_service.IssueTrackerService,
      'AddBugComment')
  def testGet_MultipleCulpritsSameAuthor_CCsAuthor(self, mock_update_bug):
  ...
  @mock.patch.object(
      update_bug_from_rietveld.issue_tracker_service.IssueTrackerService,
      'AddBugComment')
  def testGet_BisectCulpritHasSingleAuthor_CCsAuthor(self, mock_update_bug):
  ...
  def testBeautifyContent(self):
    ...
    # results log.
    actual_output = update_bug_from_rietveld._BeautifyContent(
        _BISECT_LOG_SINGLE_OWNER)
  ...
  def testConfidenceAboveThreshold_AboveThreshold(self):
    text = 'Estimated Confidence: 99.9%'
  ...
  @mock.patch(
      'google.appengine.api.urlfetch.fetch',
      mock.MagicMock(side_effect=_MockFetch))
  @mock.patch.object(update_bug_from_rietveld, '_LogBisectInfraFailure')
  def testCheckBisectBotForInfraBotFailure(self, log_bisect_failure_mock):
    ...
    update_bug_from_rietveld._CheckBisectBotForInfraFailure(
  ...
  @mock.patch(
      ...
      mock.MagicMock(side_effect=_MockFetch))
  @mock.patch.object(
      update_bug_from_rietveld, '_SendPerfTryJobEmail',
  ...
  def testGet_CreatePerfSuccessEmail(self):
    ...
    self.assertIn(_PERF_EXPECTED_SUCCESS_HTML_EMAIL,
                  _TEST_RECEIVED_EMAIL.get('html'))
    self.assertIn(_PERF_EXPECTED_SUCCESS_TEXT_EMAIL,
  ...
  def testGet_CreatePerfFailureEmail(self):
    ...
    self.assertIn(_PERF_EXPECTED_FAILURE_HTML_EMAIL,
                  _TEST_RECEIVED_EMAIL.get('html'))
    self.assertIn(_PERF_EXPECTED_FAILURE_TEXT_EMAIL,
                  _TEST_RECEIVED_EMAIL.get('body'))
    self.assertIn('just@atestemail.com',
                  _TEST_RECEIVED_EMAIL.get('to'))
  ...
  @mock.patch(
      ...
      mock.MagicMock(side_effect=_MockFetch))
  @mock.patch.object(
      update_bug_from_rietveld, '_RietveldIssueURL',
      mock.MagicMock(
  ...
  def testGet_InternalOnlyTryJob_AddsInternalOnlyBugLabel(
    ...
    mock_update_bug.assert_called_once_with(
        mock.ANY, mock.ANY,
        cc_list=mock.ANY,
        merge_issue=None, labels=['Restrict-View-Google'])
