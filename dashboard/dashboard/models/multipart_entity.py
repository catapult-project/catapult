...
"""The database models for MultipartEntity.

GAE datastore limits calls to less than 1MB.  This module adds support for
storing large objects by splitting the data to multiple entities and multiple
memcache keys.  Using ndb.get and pickle, a complex data structure can be
retrieved more quickly than datastore fetch. The object should be pickleable.

Example:
  john = Account()
  john.username = 'John'
  john.userid = 123
  multipart_entity.Set(john.userid, john)
"""
...
# Maximum number of entities and memcache to save a value.  This amounts
# to about 1MB per part.  Max is 32 GAE memcache limit.
_MAX_NUM_PARTS = 16
