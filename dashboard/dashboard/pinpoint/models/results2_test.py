  ...
  def testTypeDispatch_PushBQ_CH_Jetstream2(self, mock_commit_info,
    ...
    expected_rows = [{
        ...
        'measures': {
            ...
            'jetstream2': {
                'Score': 1,
                '3d_cube_SP.Average': 2,
                '3d_raytrace_SP.Average': 3,
                'Air.Average': 4,
                'Babylon.Average': 5,
                'Basic.Average': 6,
                'Box2D.Average': 7,
                'FlightPlanner.Average': 8,
                'HashSet_wasm.Runtime': 9,
                'ML.Average': 10,
                'OfflineAssembler.Average': 11,
                'UniPoker.Average': 12,
                'WSL.MainRun': 13,
                'acorn_wtb.Average': 14,
                'ai_astar.Average': 15,
                'async_fs.Average': 16,
                'babylon_wtb.Average': 17,
                'base64_SP.Average': 18,
                'bomb_workers.Average': 19,
                'cdjs.Average': 20,
                'chai_wtb.Average': 21,
                'coffeescript_wtb.Average': 22,
                'crypto_aes_SP.Average': 23,
                'crypto_md5_SP.Average': 24,
                'crypto_shal_SP.Average': 25,
                'crypto.Average': 26,
                'date_format_tofte_SP.Average': 27,
                'date_format_xparb_SP.Average': 28,
                'delta_blue.Average': 29,
                'earley_boyer.Average': 30,
                'espree_wtb.Average': 31,
                'first_inspector_code_load.Average': 32,
                'float_mm_c.Average': 33,
                'gaussian_blur.Average': 34,
                'gbemu.Average': 35,
                'gcc_loops_wasm.Runtime':36,
                'hash_map.Average': 37,
                'jshint_wtb.Average': 38,
                'json_parse_inspector.Average': 39,
                'json_stringify_inspector.Average': 40,
                'lebab_wtb.Average': 41,
                'mandreel.Average': 42,
                'multi_inspector_code_load.Average': 43,
                'n_body_SP.Average': 44,
                'navier_stokes.Average': 45,
                'octane_code_load.Average': 46,
                'octane_zlib.Average': 47,
                'pdfjs.Average': 48,
                'prepack_wtb.Average': 49,
                'quicksort_wasm.Runtime': 50,
                'raytrace.Average': 51,
                'regex_dna_SP.Average': 52,
                'regexp.Average': 53,
                'richards_wasm.Runtime': 54,
                'richards.Average': 55,
                'segmentation.Average': 56,
                'splay.Average': 57,
                'stanford_crypto_aes.Average': 58,
                'stanford_crypto_pbkdf2.Average': 59,
                'stanford_crypto_sha256.Average': 60,
                'string_unpack_code_SP.Average': 61,
                'tagcloud_SP.Average': 62,
                'tsf_wasm.Runtime': 63,
                'typescript.Average': 64,
                'uglify_js_wtb.Average': 65
            },
        },
        'run_id': 'fake_job_id'
    }, {
