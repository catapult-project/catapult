...
class TraceDataBuilderTest(unittest.TestCase):
  def testBasicChrome(self):
    ...
    builder.AddEventsTo(
        trace_data.BATTOR_TRACE_PART, 'battor data here', as_string=True)
  ...
  def testAsStringWithList(self):
    builder = trace_data.TraceDataBuilder()
    with self.assertRaises(AssertionError):
      builder.AddEventsTo(trace_data.BATTOR_TRACE_PART,
                          ['battor data here'], as_string=True)

  def testNotAsStringWithString(self):
    builder = trace_data.TraceDataBuilder()
    with self.assertRaises(AssertionError):
      builder.AddEventsTo(trace_data.CHROME_TRACE_PART, 'data here')
