...
class TimelineModel(event_container.TimelineEventContainer):
  def __init__(self, trace_data=None, shift_world_to_zero=True):
    ...
    Args:
        trace_data: A readable trace data value, e.g. as generated by
            trace_builder.AsData(), containing events to import.
    ...
    if trace_data is not None:
      self._ImportTraces(trace_data, shift_world_to_zero=shift_world_to_zero)
