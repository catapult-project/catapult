...
MAP_TAGS_TO_TYP_EXPECTATIONS_TAGS = {
    'All': set([]),
    'Android_Go': set(['android-go']),
    'Android_One': set(['android-one']),
    'Android_Svelte': set(['android-low-end']),
    'Android_Low_End': set(['android-low-end']),
    'Android_Webview': set(['android-webview']),
    'Android_but_not_webview': set(['android-not-webview']),
    'Mac': set(['mac']),
    'Win': set(['win']),
    'Win_7': set(['win7']),
    'Win_10': set(['win10']),
    'Linux': set(['linux']),
    'ChromeOS': set(['chromeos']),
    'Android': set(['android']),
    'Desktop': set(['desktop']),
    'Mobile': set(['mobile']),
    'Nexus_5': set(['android-nexus-5']),
    'Nexus_5X': set(['android-nexus-5x']),
    'Nexus_6': set(['android-nexus-6']),
    'Nexus_6P': set(['android-nexus-6p']),
    'Nexus_7': set(['android-nexus-7']),
    'Pixel_2': set(['android-pixel-2']),
    'Mac_10.11': set(['mac-10.11']),
    'Mac_10.12': set(['mac-10.12']),
    'Nexus6_Webview': set(['android-nexus-6', 'android-webview']),
    'Nexus5X_Webview': set(['android-nexus-5x', 'android-webview']),
    'Android_Go_Webview': set(['android-go', 'android-webview']),
    'Pixel2_Webview': set(['android-pixel-2', 'android-webview'])
}
