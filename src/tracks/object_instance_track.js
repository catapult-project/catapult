...
base.requireStylesheet('tracks.object_instance_track');
...
base.exportTo('tracing.tracks', function() {
  ...
  var ObjectInstanceTrack = tracing.ui.define(tracing.tracks.CanvasBasedTrack);
  ...
  ObjectInstanceTrack.prototype = {
    ...
    redraw: function() {
      ...
      var loI = tracing.findLowIndexInSortedArray(
        objectInstances,
        function(instance) {
      ...
      loI = tracing.findLowIndexInSortedArray(
        objectSnapshots,
        function(snapshot) {
          return snapshot.ts +
            snapshotRadiusWorld;
    ...
    addIntersectingItemsInRangeToSelectionInWorldSpace: function(
      ...
      tracing.iterateOverIntersectingIntervals(
        this.objectSnapshots_,
