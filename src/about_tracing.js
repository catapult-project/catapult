...
window.FLATTENED['slice'] = true;
window.FLATTENED['slice_group'] = true;
window.FLATTENED['async_slice_group'] = true;
window.FLATTENED['sample'] = true;
window.FLATTENED['thread'] = true;
window.FLATTENED['counter'] = true;
window.FLATTENED['process_base'] = true;
window.FLATTENED['process'] = true;
window.FLATTENED['kernel'] = true;
window.FLATTENED['cpu'] = true;
...
window.FLATTENED['v8_log_reader'] = true;
window.FLATTENED['v8_splaytree'] = true;
window.FLATTENED['v8_codemap'] = true;
window.FLATTENED['v8_log_importer'] = true;
...
<include src="guid.js">
<include src="slice.js">
<include src="slice_group.js">
<include src="async_slice_group.js">
<include src="sample.js">
<include src="thread.js">
<include src="counter.js">
<include src="process_base.js">
<include src="process.js">
<include src="kernel.js">
<include src="cpu.js">
...
<include src="v8_log_reader.js">
<include src="v8_splaytree.js">
<include src="v8_codemap.js">
<include src="v8_log_importer.js">
